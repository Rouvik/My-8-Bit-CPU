...
#define RASM_VERSION 1.5 // rasm version number
...
std::string processLine(std::string line)
{
	...
	int colpos = line.find(":");
	if (colpos != -1)
		return ""; // labels already picked ignore
...
{
	std::cout << "RASM - Rouvik\'s Assembler - version " << RASM_VERSION << '\n';
	...
	std::cout << "Assembling: " << argv[1] << " to " << argv[2] << '\n';
